...
export const AiHub: React.FC<Props> = ({ user, onTabChange, settings }) => {
  ...
  return (
    <div className="space-y-6 pb-24 p-4 animate-in fade-in">
      ...
      {/* HEADER */}
      <div className="bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-900 p-6 rounded-3xl text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-2xl font-black mb-1 flex items-center gap-2">
            <Sparkles className="text-yellow-400" /> AI Center
          </h2>
          <p className="text-indigo-200 text-sm">
            Your personal learning assistant powered by advanced AI.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-xs text-slate-600">
              Get a study routine based on your history.
            </p>
          </div>
          <div className="text-slate-300">
            <Zap size={16} />
            ...
            <div className="flex-1 overflow-y-auto pr-1 custom-scrollbar">
              {!generatedPlan ? (
                <div className="text-center py-12 px-4">
                  <div className="bg-indigo-50 border border-indigo-100 p-6 rounded-full inline-block mb-6 animate-pulse shadow-inner">
                    <Sparkles size={40} className="text-indigo-600" />
                  </div>
                  <h3 className="text-2xl font-black text-slate-800 mb-3 tracking-tight">
                    Create Your Success Plan
                  </h3>
                  <p className="text-slate-600 mb-8 text-sm max-w-sm mx-auto leading-relaxed">
                    Our AI will deeply analyze your past test performance and
                    create a targeted, custom 3-day schedule to fix your weakest
                    concepts.
                  </p>
