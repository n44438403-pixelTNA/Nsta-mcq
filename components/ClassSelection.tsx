            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className={`text-2xl font-bold mb-1 ${isLocked ? 'text-slate-500' : 'text-slate-800'}`}>
                      {cls === 'COMPETITION' ? 'Competition' : `Class ${cls}`}
                  </h3>
                  <p className={`text-sm ${isLocked ? 'text-slate-300' : 'text-slate-600 group-hover:text-slate-600'}`}>
