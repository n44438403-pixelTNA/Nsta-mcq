    ...
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        <div className="flex p-1 bg-slate-100 rounded-xl mb-6">
            <button
                ...
                className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${activeTab === 'SAVED' ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:text-slate-700'}`}
            >
                Saved Notes
            </button>
            <button
                onClick={() => setActiveTab('ACTIVITY')}
                className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${activeTab === 'ACTIVITY' ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:text-slate-700'}`}
            >
                Activity Log
            </button>
            <button
                onClick={() => setActiveTab('OFFLINE')}
                className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${activeTab === 'OFFLINE' ? 'bg-white shadow text-slate-800' : 'text-slate-600 hover:text-slate-700'}`}
            >
                Offline Saved
            </button>
        </div>
